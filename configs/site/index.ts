...
export const siteConfig = {
  brand: {
    ...
    description: 'Internet Service Provider yang menguasai nusantara dengan koneksi secepat kilat petir! Untuk para jagoan digital Indonesia!',
  ...
  seo: {
    ...
    description: 'Provider internet terbaik Indonesia dengan koneksi fiber optic super cepat dan stabil. Melayani rumahan dan bisnis di seluruh Nusantara.',
