  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20">
        ...
        <div
          className="absolute top-32 right-20 text-3xl float-gentle"
          style={{ animationDelay: '1s' }}
        >
          👒
        </div>
        <div
          className="absolute bottom-40 left-16 text-3xl float-gentle"
          style={{ animationDelay: '2s' }}
        >
          🍚
        </div>
        <div
          className="absolute top-1/3 right-10 text-4xl float-gentle"
          style={{ animationDelay: '0.5s' }}
        >
          🎭
        </div>
        <div
          className="absolute bottom-20 right-32 text-3xl float-gentle"
        ...
        <div className="space-y-12 slide-in-up">
          ...
          <div className="space-y-8">
            ...
            <div className="professional-bubble inline-block mb-8">
              <h1 className="cartoon-title text-4xl md:text-6xl lg:text-7xl text-slate-900 leading-tight">
                <span className="block indonesia-gradient">
                  JAWARA INTERNET
                </span>
                <span className="block text-2xl md:text-4xl lg:text-5xl mt-2 text-slate-800">
                  NUSANTARA RAYA 🏝️
                </span>
              </h1>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <p className="cartoon-text text-xl md:text-2xl text-gray-200 mb-6 leading-relaxed">
                Internet{' '}
                <span className="text-orange-400 font-black">super ngebut</span>{' '}
                untuk para{' '}
                <span className="text-blue-400 font-black">jagoan digital</span>{' '}
                Indonesia! 🦸‍♂️
              </p>
              <p className="cartoon-text text-lg md:text-xl text-gray-300 leading-relaxed">
                Koneksi{' '}
                <span className="text-yellow-400 font-bold">secepat kilat</span>
                , stabil <span className="text-green-400 font-bold">24/7</span>,
                harga bersahabat!
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="professional-card p-6 text-center">
              ...
              <h3 className="cartoon-text text-lg font-bold text-white mb-2">
                Kecepatan Kilat
              </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 max-w-4xl mx-auto">
            ...
            <div className="professional-card p-6 text-center">
              <div className="text-3xl md:text-4xl font-black text-purple-500 mb-2">
                24/7
              </div>
