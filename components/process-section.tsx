  ...
  const steps = [
    {
      ...
      description:
        'Daftar online atau via telepon. Cuma butuh 2 menit, gampang banget!',
      details: [
        'Data diri lengkap',
    ...
    },
    {
      ...
      title: 'Survey Lokasi',
      description:
        'Tim teknisi datang ke lokasi untuk cek kelayakan dan jarak dari tower terdekat.',
      details: [
        'Cek sinyal coverage',
        'Ukur jarak kabel',
        'Tentukan titik instalasi',
      ],
      color: 'blue',
    },
    {
      ...
      description:
        'Pemasangan kabel fiber optic dan konfigurasi router. Dikerjain sama teknisi berpengalaman!',
    ...
    },
    {
      ...
      description:
        'Internet siap dipakai! Selamat menikmati koneksi super cepat tanpa buffering.',
    ...
    <section id="process" className="py-20 bg-slate-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle
          ...
          subtitle="Dari daftar sampai internetan, cuma 4 langkah mudah!"
        />
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-400">
              Dari survey sampai internet aktif, maksimal 3 hari kerja
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400">
              Survey lokasi dan konsultasi 100% gratis, no hidden cost
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400">
              Tim support siap membantu kapan aja kamu butuh
            </p>
          </div>
        </div>
