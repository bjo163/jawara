  ...
  return (
    <section id="coverage" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle
          title="Area Coverage"
          subtitle="Cek apakah lokasi kamu sudah ter-cover jaringan Jawara-Net"
        />
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  <MapPin
                    className={`h-6 w-6 ${area.status === 'active' ? 'text-green-500' : 'text-orange-500'}`}
                  />
        ...
        <div className="mt-16 bg-gradient-to-r from-slate-800/50 to-slate-700/30 p-8 rounded-2xl border border-gray-700">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-3xl mx-auto">
              Kami terus memperluas jangkauan! Kalau lokasi kamu belum
              ter-cover, daftar dulu biar kami prioritaskan area kamu untuk
              ekspansi berikutnya.
            </p>
