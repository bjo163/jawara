...
export function PageHeader({
  ...
  return (
    <header
      className={`border-b border-gray-800 bg-slate-900/50 backdrop-blur-xl sticky top-0 z-50 ${className}`}
    >
...
export function ContactPageHeader({
  ...
  return (
    <div
      className={`bg-slate-900/80 backdrop-blur-md border-b border-gray-800 sticky top-0 z-50 ${className}`}
    >
