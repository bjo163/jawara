...
export function PackagesSection() {
  ...
  const currentPackages =
    activeCategory === 'rumah' ? rumahanPackages : bisnisPackages

  return (
    <section
      id="packages"
      className="py-20 bg-gradient-to-br from-slate-900/50 to-purple-900/20"
    >
        ...
        <div className="mt-16 professional-card p-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h4 className="cartoon-text font-bold text-white text-lg mb-2">
                Gratis Instalasi
              </h4>
              <p className="cartoon-text text-gray-400">
