...
export const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Pembayaran bisa dilakukan bulanan via transfer bank, e-wallet (OVO, GoPay, DANA), atau datang langsung ke kantor. Kami juga menyediakan sistem auto-debit untuk kemudahan. Tagihan akan dikirim via SMS/email setiap bulannya.',
    category: 'pembayaran',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Tim technical support kami siap membantu 24/7! Bisa hubungi via telepon, email, atau aplikasi customer service. Untuk masalah ringan, kami bisa remote troubleshooting. Kalau perlu teknisi datang, biasanya dalam 2-4 jam sudah ditangani.',
    category: 'teknis',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Ya! Setiap instalasi disertai dengan router WiFi berkualitas tinggi yang sudah dikonfigurasi siap pakai. Untuk paket bisnis, kami menyediakan perangkat enterprise grade sesuai kebutuhan jaringan kamu.',
    category: 'teknis',
  },
  {
    question: 'Berapa kecepatan internet yang sebenarnya?',
    answer:
      "Kecepatan yang kami berikan adalah kecepatan real, bukan 'up to'. Jadi paket 100 Mbps benar-benar dapat 100 Mbps! Kami menggunakan teknologi fiber optic murni untuk memastikan konsistensi kecepatan.",
    category: 'teknis',
  },
  {
    question: 'Bagaimana cara membatalkan langganan?',
    answer:
      'Pembatalan bisa dilakukan dengan memberitahu customer service minimal 7 hari sebelum tanggal billing. Tidak ada denda pembatalan. Perangkat yang dipinjamkan harus dikembalikan dalam kondisi baik.',
    category: 'umum',
  },
  {
    question: 'Apakah ada layanan static IP?',
    answer:
      'Ya, tersedia layanan static IP untuk kebutuhan bisnis seperti server, CCTV remote, atau aplikasi khusus. Ada biaya tambahan per bulan untuk layanan static IP ini.',
    category: 'teknis',
  },
]
